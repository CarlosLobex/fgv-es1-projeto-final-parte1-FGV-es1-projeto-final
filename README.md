...
Backend: Node.js, Express, SQLite (repositório)
Frontend: React (repositório)
...
Fork dos repositórios esmforum e esmforum-react
...
Categorização de perguntas (tags: tecnologia, carreira, dúvidas-gerais, etc.)
Perfil de usuário com histórico de perguntas e respostas
Notificação de novas respostas às suas perguntas
